        ...
        <section className="contact rounded-md mt-4 dark:bg-black bg-white">
            <div className="relative">
                <div className="md:flex md:columns-2 gap-4">
                    ...
                    <h2 className="card-title text-md mb-4">Recent Work:</h2>
                        <div className="card">
                            <div className="work flex mb-4">
                                ...
                                <div className="description-section md:w-4/6 lg:w-5/6">
                                    <h3 className="work-title text-xl">
                                        ...
                                        <small className='text-xs text-[#6c757d]'>Sep 2, 2023</small>
                                        <span  className='text-xs text-[#6c757d]'>-</span>
                                        <small className='text-xs text-[#6c757d]'>Present</small>
                                    </h3>
                                    <p>
                                        <small className="work-description">
                                            I create a full-stack web application using React/NextJS, PostgreSQL, and ShadCN. I&apos;ve also created APIs to support mobile payments etc...
                                        </small>
                                    </p>
                                </div>
                            </div>
                            <div className="work flex mb-4">
                                ...
                                <div className="description-section md:w-4/6 lg:w-5/6">
                                    <h3 className="work-title text-xl">
                                        ...
                                        <small className='text-xs text-[#6c757d]'>Jan 9, 2023</small>
                                        <span className='text-xs text-[#6c757d]'>-</span>
                                        <small className='text-xs text-[#6c757d]'> Present</small>
                                    </h3>
                                    <p>
                        ...
                        <div className="card py-0">
                            <div className="card-body px-0">
                                <ul className="list-unstyled border dark:border-gray-700 ml-2.5 marker:text-sky-400 list-disc py-3 ps-6 rounded-lg text-slate-400 space-y-2 text-sm">
                                    <li><i className="bi bi-check-circle-fill text-success"></i>UI/UX Web Design</li>
                                    <li><i className="bi bi-check-circle-fill text-success"></i>Full-stack Web Development</li>
                                    <li><i className="bi bi-check-circle-fill text-success"></i>React/Javascript Development</li>
                                    <li><i className="bi bi-check-circle-fill text-success"></i>Mobile App Development</li>
                                    <li><i className="bi bi-check-circle-fill text-success"></i>Technical/Software Writing</li>
                                </ul>
